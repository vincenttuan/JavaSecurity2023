...
public class RSAChunkedEncryption {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Alice 使用 Bob 的公鑰對合併後的訊息進行分段RSA加密
        byte[] encryptedMessage = KeyUtil.encryptWithPublicKey(bobKeyPair.getPublic(), combinedMessage.getBytes());

        // 這裡模擬 Alice 發送加密後的訊息到 Bob

        // Bob 使用他的私鑰對加密的訊息進行分段RSA解密
        byte[] decryptedMessageBytes = KeyUtil.decryptWithPrivateKey(bobKeyPair.getPrivate(), encryptedMessage);
